...
{
   GLfloat fogColor[4] = {0.0, 0.25, 0.25, 1.0}; // darkcyan
   f1 = 1.0f;
   f2 = 5.0f;
   f3 = 10.0f;
   ...
   glClearColor(0.0, 0.25, 0.25, 1.0);  /* fog color : darkcyan */
}
...
void display(void)
{
   ...
   glColor3f (1.0f, 0.75f, 0.0f); // Orange
