 ...
 * OpenGL Sample
 * 2020-03-01 K.OHWADA
 * original : https://www.opengl.org/archives/resources/code/samples/redbook/
 */
...
{
   GLfloat torus_diffuse[] = { 0.7, 0.7, 0.0, 1.0 }; // Yellow
   GLfloat cube_diffuse[] = { 0.0, 0.7, 0.7, 1.0 }; // Teal
   GLfloat sphere_diffuse[] = { 0.7, 0.0, 0.7, 1.0 }; // Purple
   GLfloat octa_diffuse[] = { 0.7, 0.4, 0.4, 1.0 }; // Brown
